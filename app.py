...
with st.sidebar:
    ...
    st.divider()
    st.caption("PDF desteği: " + ("✅ aktif" if PDF_ENABLED else "❌ kapalı (pdf2image/poppler yok)"))
    st.caption("OCR desteği: " + ("✅ aktif" if OCR_ENABLED else "❌ kapalı (tesseract/pytesseract yok)"))

...
if api_key:
    ...
    try:
        # Modelleri tara, isimlendirme hatasını (404) engelle
...
# --- 3. VERİ BAĞLANTISI (YAZMA YETKİSİ İÇİN KRİTİK) ---
edit_url = "https://docs.google.com/spreadsheets/d/1gow0J5IA0GaB-BjViSKGbIxoZije0klFGgvDWYHdcNA/edit#gid=0"
# ÖNEMLİ: Secrets'ta Service Account tanımlı olmalı
...
# --- 6. VERİ YÖNETİMİ ---
    ...
    if up_img and st.button("AI İle Analiz Et"):
        with st.spinner(f"Modelle okunuyor: {target_model}"):
            try:
        ...
        with st.form("onay_formu"):
            ...
            if st.form_submit_button("✅ Kaydet"):
                try:
                    ...
                    # YAZMA İŞLEMİ (Service Account yetkisi şarttır)
                    ...
                    st.error(f"Kayıt Hatası: {e}. Sheets API ve Service Account yetkilerini kontrol edin.")
